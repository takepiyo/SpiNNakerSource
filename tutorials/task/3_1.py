...
synapse = p.StaticSynapse(
    RandomDistribution("normal_clipped", mu=0.1, sigma=0.1, low=0.0, high=np.inf, rng=rng), RandomDistribution("normal_clipped", mu=1.5, sigma=0.75, low=1.0, high=1.6, rng=rng))
...
p.Projection(exc_pop, exc_pop, p.FixedProbabilityConnector(
    0.1, rng=rng), synapse, receptor_type="excitatory")
synapse = p.StaticSynapse(
    RandomDistribution("normal_clipped", mu=-0.4, sigma=0.1,
